   ...
   <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="well well-sm">
          <form class="form-horizontal" action="modifyProBoard?boa_category=${boa_category}" method="post">
          <fieldset>
            <legend class="text-center"><h2><P>요청게시판 글수정</P></h2></legend>
    		<input type="hidden" name="boa_id" value="${boa_id}">
    		<input type="hidden" name="mem_id" value="${mem_id}">
    		<input type="hidden" name="boa_ip" value="${boa_ip}">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <textarea id="email" name="boa_subject" type="text"  class="form-control" rows="1" >${boa_subject}</textarea>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <textarea class="form-control" id="message" name="boa_content"  rows="5" >${boa_content}</textarea>
              </div>
            </div>
        ...
        <!-- Form actions -->
            <div class="form-group">
              <div class="col-md-12 text-right">
                ...
                <input class="btn btn-primary btn-lg" type="button" value="목록" onclick="window.location='RequestBoard?pageNum=${pageNum}&boa_category=${boa_category}'">
              </div>
            </div>
          </fieldset>
          </form>
