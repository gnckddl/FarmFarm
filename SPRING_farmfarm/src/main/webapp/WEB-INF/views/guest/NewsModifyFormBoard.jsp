   ...
   <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="well well-sm">
          <form class="form-horizontal" action="NewsModifyBoardPro" method="post" enctype="multipart/form-data">
          <fieldset>
            <legend class="text-center"><h2><P>소식게시판 글수정</P></h2></legend>
        ...
        <!-- Form actions -->
            <div class="form-group">
              <div class="col-md-12 text-right">
                ...
                <input class="btn btn-primary btn-lg" type="button" value="목록" onclick="window.location='memberQuestionBoard?pageNum=${pageNum}&boa_category=${boa_category}'">
              </div>
            </div>
          </fieldset>
          </form>
