...
<div class="container">
   <div class="row">
        ...
        <button onclick="window.location='RequestBoardWrite'" style="margin-left:1050px; margin-bottom:10px; color:#00A58A;"><b>글쓰기</b></button>
 ...
 <c:if test="${cnt > 0}">
    <c:forEach var="dto" items="${dtos}">
       <tr>
         ...
         <td align="center">
            <a href="RequestBoardContent?boa_id=${dto.boa_id}&pageNum=${pageNum}&number=${number+1}">${dto.boa_content}</a>
         </td>
         ...
         <!-- 페이지 컨트롤 -->
               <c:if test="${cnt>0 }">
                  ...
                  <c:if test="${startPage > pageBlock}">
                     <li class="disabled"><a href="RequestBoard?${startPage - pageBlock}">
                     ...
                     <c:forEach var ="i" begin="${startPage}" end="${endPage}">
                        ...
                        <c:if test="${i != currentPage}">
                           <li><a href="RequestBoard?pageNum=${i}">${i}</a></li>
                        </c:if>
                     </c:forEach>
                     <c:if test="${pageCount > endPage}">
                     <li><a href="RequestBoard?pageNum=${startPage + pageBlock}"><span
