...
<div class="container">
	<div class="row">
        ...
        <div class="col-md-12">
        <h4 align="center" style="margin-bottom:30px; color:#00A58A;"><b>회원문의게시판</b></h4>
        <button onclick="window.location='memberQuestionBoardWrite?pageNum=${pageNum}&boa_category=2'" style="margin-left:1050px; margin-bottom:10px; color:#00A58A;"><b>글쓰기</b></button>
        ...
        <tr align="center">
         <td style="width:10%"><b>번호</b></td>
          <td style="width:10%"><b>아이디</b></td>
           <td style="width:10%"><b>문의제목</b></td>
           <td style="width:20%"><b>문의내용</b></td>
