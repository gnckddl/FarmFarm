...
<script src="http://momentjs.com/downloads/moment-timezone-with-data.js"></script>
  ...
  <div class="row">
    <div class="col-md-5 col-md-offset-4" style="margin-bottom:170px; margin-top:150px;">
      <form class="form-horizontal" role="form" method="post" action="Auction_ApplyPro" enctype="multipart/form-data">
        <fieldset>

          <!-- Form Name -->
          <legend style=" color:#00A58A;">경매 상품 등록하기</legend>
        ...
        <form class="form-horizontal col-sm-7 col-sm-offset-2" action="" method="post">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" placeholder="Country" name="stock_regDate" class="form-control">
            </div>
          </div>
           ...
           <div class="form-group">
            <label class="col-sm-2 control-label" for="textinput" style=" color:#00A58A;">경매 마감 기간</label>
            <div class="col-sm-4">
              <input type="date" class="form-control"  style="width:150px;" name= "auc_term" > <!--  ~ <input class="form-control" type="date" style="width:150px;" name="last"> -->
            </div>
          </div>
