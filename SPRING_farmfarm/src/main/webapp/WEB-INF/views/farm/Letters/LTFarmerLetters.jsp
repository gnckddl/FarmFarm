...
//﻿답변한 쪽지함으로 넘어가는 버튼 스크립트
function Replay() {
	window.location = 'replyletters';
}
</script>
<!-- 페이지 자체 자바스크립트 끝 -->
<!-- 페이지 내 자체 CSS -->
...
<div class="container">
    ...
    <div class="huge-top">
    	<div style="margin-left:800px; margin-bottom: 10px;">
    		<tr>
    			<td>
        			<button class="form-control btn btn-login" id="insertUserletter" onclick="window.open('LTFarmerReply', 'write','top=100px, left=100px, height=500px, width=500px')">쪽지보내기</button>
        		</td>
        		<td>
        			<button class="form-control btn btn-login" id="replyletters" onclick="javascript:Replay();"style="margin-right: 20px">답변 쪽지함</button>
        		</td>
    		</tr>    
    	</div>
	</div>
