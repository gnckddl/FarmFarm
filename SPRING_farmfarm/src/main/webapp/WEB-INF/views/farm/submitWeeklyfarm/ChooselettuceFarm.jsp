...
<form action="ChooseFarmPro" method="post" name="ChooseFarm">
	...
	<input type="hidden" name="wfarm_status" value="${wfarm_status}">
	<!-- 요청상태코드 1번 요청완료 -->
			...
			<div class="card-block">
				...
				<div class="embed-responsive embed-responsive-16by9">
					<img class="embed-responsive-item"
						src="resources/images/farmer/farmview01.PNG" />
				</div>
			</div>
		</div>
		<hr class="my-4">
		<div class="text-center darken-grey-text mb-4">
			<h3 class="font-bold mb-3">상추농원 주말농장 신청서 작성하기</h3>
		</div>
	</div>
	<!--MDB --> </main>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="textinput">개설 농장
			닉네임</label>
		<div class="col-sm-10">
			<input type="text" name="wfarminfo_title"
				placeholder="임대하실 상추 농원 텃밭의 개인 이름을 지어주세요" style="font-size: 20px;"
				class="form-control">
		</div>
	</div>
