...
<form action="ChooseFarmPro" method="get" name="ChooseFarm">
	<main> <!--MDB -->
			...
			<div class="card-block">
				...
				<div class="embed-responsive embed-responsive-16by9">
					<img class="embed-responsive-item"
						src="resources/images/farmer/farmview04.PNG" />
				</div>
			</div>
		</div>
		<hr class="my-4">
		<div class="text-center darken-grey-text mb-4">
			<h3 class="font-bold mb-3">꽃님이네 수박농원 주말농장 신청서 작성하기</h3>
		</div>
	</div>
	<!--MDB --> </main>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="textinput">Partner
			ID</label>
		<div class="col-sm-10">
			<input type="text" name="mem_id" placeholder="팜팜 파트너 ID을 입력하세요"
				class="form-control" style="font-size: 20px;" value="${sessionScope.userId}">
		</div>
	</div>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="textinput">개설 농장
			닉네임</label>
		<div class="col-sm-10">
			<input type="text" name="wfarminfo_title" autocomplete="off"
				placeholder="위 예시를 참조해 임대하실 텃밭의 개인 이름을 지어주세요" class="form-control"
