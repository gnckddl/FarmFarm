...
<form action="ChooseFarmPro" method="get" name="ChooseFarm">
			...
			<div class="card-block">
				...
				<div class="embed-responsive embed-responsive-16by9">
					<img class="embed-responsive-item"
						src="resources/images/farmer/farmview08.PNG" />
				</div>
			</div>
		</div>
		<hr class="my-4">
		<div class="text-center darken-grey-text mb-4">
			<h3 class="font-bold mb-3">우리네 사과 가족농원 주말농장 신청서 작성하기</h3>
		</div>
	</div>
	<!--MDB --> </main>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="textinput">Partner
			ID</label>
		<div class="col-sm-10">
			<input type="text" name="mem_id" value="${sessionScope.userId}"
			placeholder="팜팜 파트너 ID을 입력하세요" class="form-control" style="font-size: 20px;">
		</div>
	</div>
