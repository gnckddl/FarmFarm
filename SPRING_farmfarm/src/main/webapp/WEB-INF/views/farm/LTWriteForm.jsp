    			...
    			<div class="form-area">  
                  ...
                  <!--   <h3 style="margin-bottom: 25px; text-align: center;">Contact Form</h3> -->
    						<div class="form-group">
								<input type="text" class="form-control" id="name" name="letterwritter" value="${sessionScope.userId}" readonly="readonly">
							</div>
							<div class="form-group">
								<input type="text" class="form-control" id="email" name="lettersubject" placeholder="제목" required>
							</div>
                    		<div class="form-group">
                    			<textarea class="form-control" type="textarea" name="lettercontent" id="message" placeholder="문의내용" maxlength="140" rows="7"></textarea>
                        			<span class="help-block"><h4><p id="characterLeft" class="help-block ">담당 농부님 부재 시 답변은 1~2일 소요되실 수 있습니다.</p></h4></span>                    
                    		</div>
								 <input type="submit" id="lettersubmit" class="form-control btn btn-login" value="제출">
